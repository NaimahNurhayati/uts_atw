  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="{{url('artikel/create')}}" class="nav-link btn btn-outline-info {{checkRouteActive('artikel/create')}}">
        ...
        <li class="nav-item">
          <a href="{{url('komentar')}}" class="nav-link {{checkRouteActive('komentar')}}">
